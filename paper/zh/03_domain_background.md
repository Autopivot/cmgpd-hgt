...
**目标缺口（jiapu）。** 在中国家谱（*jiapu*，家谱）中，父系（patriline）是记录的基本单位。每一位男性后裔都按世代条目进入族谱，而女性后裔通常至多在父亲条目下出现一个姓氏 —— 在许多族谱中，她一旦出嫁便被彻底略去。*muxia*（母家）—— 妻子追溯其本宗的母方家户 —— 因此成为一个在结构上不可见、但在历史上至关重要的节点：它中介政治结盟、乳母网络、旗下劳役交换以及继承纠纷 [wang2007muxia]。父系记录传统因此在源头上阻断了任何从族谱本身重建 *muxia* 的尝试：横向的亲属通道在源头层面就根本不存在。
