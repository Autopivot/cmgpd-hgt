...
**The target gap (jiapu).** In Chinese family genealogies (*jiapu*, 家谱), the patriline is the unit of record. Each male descendant is enumerated as a generation entry in the lineage book, while a female descendant typically appears at most as a surname on her father's entry — and in many lineage books she is omitted entirely upon marriage. The *mujia* (母家) — the maternal household to which a wife traces her natal lineage — is therefore a structurally invisible but historically pivotal node: it mediated political alliances, wet-nurse networks, banner-tax labour exchange, and inheritance disputes [wang2007mujia]. The patrilineal record convention thus blocks any reconstruction of the *mujia* from the genealogical record itself: the lateral kinship channel is simply absent from the source.
